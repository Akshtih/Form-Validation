...
const saveToLocalStorage = () => {
    ...
    localStorage.setItem('confirm-password', confirmPasswordEl.value);
};
...
const restoreFromLocalStorage = () => {
    ...
    confirmPasswordEl.value = localStorage.getItem('confirm-password') || '';
};

// Restore input values when the page loads
document.addEventListener('DOMContentLoaded', restoreFromLocalStorage);

// Save input values whenever the user types
